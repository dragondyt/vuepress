...
const convertRGB = (value: number): string => {
...
const mixValue = (a, b, ratio): number => a + (b - a) * ratio
...
export class Color {
  ...
  constructor(color) {
    ...
    if (
      ...
      throw new RangeError(
        `{r: ${this.r}, g: ${this.g}, b: ${this.b}, a: ${this.a}} is invalid.`
      )
    }
  }
  ...
  toString(): string {
    ...
    return `rgba(${this.r}, ${this.g}, ${this.b}, ${parseFloat(
      this.a.toFixed(2)
    )})`
  }
