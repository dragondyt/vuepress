export default {
  ...
  post: {
    ...
    copyright: {
      ...
      license_content:
        'All articles in this blog are licensed under %s unless stating additionally.',
  ...
  tips: {
    copyright:
      'Copied to clipboard successfully! <br> All articles in this blog are licensed under %s.',
