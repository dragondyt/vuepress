...
const defaultOptionsLocaleSet: Record<string, SakuraThemeOptions> = {
    "en-US": {
        notFound: [
...
export const assignDefaultOptions = (app: App, options: SakuraThemeOptions) => {
    ...
    Object.assign(options, {
        // @ts-ignore
        image_list: load(fs.readFileSync(app.dir.source('data/images.yml')))
    })
}